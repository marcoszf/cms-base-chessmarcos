...
@section('content')
	...
	<div class="page-header">
	    <div class="page-title">
	      <h3>Cadastrar usuário <small>Nesta página você pode cadastrar um usário de acesso ao cms </small></h3>
	    </div>
  	</div>
	...
	<div class="breadcrumb-line">
		<ul class="breadcrumb">
		  ...
		  <li><a href="{{ URL::to('user/showInsert') }}">Você está em Cadastrar usuário</a></li>
	...
	<section id="content-users-form-insert">
	 	<h6 class="heading-hr"><i class="icon-user"></i> Informações do Usuário:</h6>
		{{ Form::open(array('url' => url('user/insert'), 'class'=>'form')) }}
			...
			<div class="block-inner">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-6">
							...
							{{ Form::text('username', Input::old('username'), array('class' => 'form-control', 'placeholder' => 'Digite um nome de usuário')) }}
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-6">
                            {{ Form::label('password', 'Senha') }} <span class="mandatory">*</span>
                        ...
                        <div class="col-md-6">
                            {{ Form::label('password-repeat', 'Confirmação da senha') }} <span class="mandatory">*</span>
