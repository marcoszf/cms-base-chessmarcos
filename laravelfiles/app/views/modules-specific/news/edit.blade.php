...
@section('content')
	...
	<div class="page-header">
	    <div class="page-title">
	      <h3>{{ Lang::get('mod-news/infoMsg.TITLE_EDIT') }}<small>{{ Lang::get('mod-news/infoMsg.DESCRIPTION_PAGE_EDIT') }} </small></h3>
	    </div>
  	</div>
	...
	<div class="breadcrumb-line">
		<ul class="breadcrumb">
		  ...
		  <li><a href="{{ URL::to('banner/showList') }}">{{ Lang::get('mod-news/infoMsg.BREADCRUMB_BACK_CURRENT_LIST') }}</a></li>
		  <li><a href='{{ URL::to("banner/$banner->id/showEdit") }}'>{{ Lang::get('mod-news/infoMsg.BREADCRUMB_CURRENT_EDIT') }}</a></li>
			...
			<div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="alert alert-success fade in block-inner">
                        ...
                        {{ Lang::get('mod-news/infoMsg.INFO_FILL_FIELDS') }}
                    </div>

                    <div class="form-group"><!-- Nome do Banner -->
                        <div class="col-md-8">
                            {{ Form::label('title', Lang::get('mod-news/infoMsg.LABEL_BAN_TITLE')) }} <span class="mandatory">*</span>
							{{ Form::text('title', Input::old('title'), array('class' => 'form-control', 'placeholder' => Lang::get('mod-news/infoMsg.PH_BAN_TITLE'))) }}
                    ...
                    <div class="form-group"><!-- Link do Banner -->
                        <div class="col-md-8">
                            {{ Form::label('link', Lang::get('mod-news/infoMsg.LABEL_BAN_LINK')) }}
                            {{ Form::text('link', Input::old('link'), array('class' => 'form-control', 'placeholder' => Lang::get('mod-news/infoMsg.PH_BAN_LINK'))) }}
                    ...
                    <div class="form-group"><!-- Data Inicial do Banner -->
                        <div class="col-md-8">
                            {{ Form::label('show_begin', Lang::get('mod-news/infoMsg.LABEL_BAN_BEGIN')) }} <span class="mandatory">*</span>
                            {{ Form::text('show_begin', $datetime_begin, array('class' => 'form-control', 'id'=>'dt_inicio_ins', 'placeholder' => Lang::get('mod-news/infoMsg.PH_BAN_BEGIN'))) }}
                    ...
                    <div class="form-group"><!-- Data final do Banner -->
                        <div class="col-md-8">
                            {{ Form::label('show_end', Lang::get('mod-news/infoMsg.LABEL_BAN_END')) }} <span class="mandatory">*</span>
                            {{ Form::text('show_end', $datetime_end, array('class' => 'form-control', 'id'=>'dt_fim_ins', 'placeholder' => Lang::get('mod-news/infoMsg.PH_BAN_END'))) }}
                            @if ($errors->has('show_end')) <p class="help-block"><span class="redalert">{{ $errors->first('show_end') }}</span></p> @endif
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="imagem">{{ Lang::get('mod-news/infoMsg.LABEL_IMAGE') }}</label>
                        <div class="col-sm-10">
                            <input type="file" class="styled form-control" name="imagem" id="report-screenshot">
                            <span class="help-block">{{ Lang::get('mod-news/infoMsg.INFO_EXTENSION_SUP') }}</span>
                        </div>
                    </div>
                    <?php 
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title">{{ Lang::get('mod-news/infoMsg.LABEL_IMAGE') }}</h4>
                                    </div>
                                    ...
                                    <div class="modal-footer">
                                        <button class="btn btn-warning" data-dismiss="modal"><i class="icon-cancel-circle"></i> {{ Lang::get('mod-news/infoMsg.BTN_IMG_CLOSE') }}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="block-inner">
                                ...
                                <input type="radio" name="status" value="A" id="status" <?php if( $banner->status== "A") { echo 'checked="checked"'; } ?> >{{ Lang::Get('mod-news/infoMsg.LABEL_ACTIVE') }}
                                </label>
                                <label class="radio-inline radio-info">
                                    <input type="radio" name="status" value="I" id="status" <?php if( $banner->status== "I") { echo 'checked="checked"'; } ?> >{{ Lang::Get('mod-news/infoMsg.LABEL_INACTIVE') }}
                                </label>
                ...
                <div class="text-center">
	              {{ Form::submit( Lang::Get('mod-news/infoMsg.BTN_REGISTER') , array('class'=>'btn btn-success')) }}
	              {{ Form::reset(Lang::Get('mod-news/infoMsg.BTN_CANCEL'), array('class'=>'btn btn-default')) }}
	            </div>
            </div>
        </div>
